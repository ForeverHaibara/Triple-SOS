...
class CachedBasis():
    ...
    def _inquire_monoms(self, n: int):
        if not (n in self.dict_monoms.keys()):
            self.dict_monoms[n] , self.inv_monoms[n] = self._generate_expr(n)
...
def _get_dict_monom_and_inv_monom(poly, dict_monom: Optional[Dict] = None, inv_monom: Optional[List] = None):
    if not isinstance(poly, int):
        poly = deg(poly)

    if dict_monom is None or inv_monom is None:
        dict_monom, inv_monom = _cached_basis._inquire_monoms(poly)
    return dict_monom, inv_monom


def arraylize(poly, dict_monom: Optional[Dict] = None, inv_monom: Optional[List] = None):
    """
    Turn a sympy polynomial into arraylike representation.
    """
    dict_monom, inv_monom = _get_dict_monom_and_inv_monom(poly, dict_monom, inv_monom)
...
def arraylize_sp(poly, dict_monom: Optional[Dict] = None, inv_monom: Optional[List] = None):
    """
...
def invarraylize(poly, dict_monom: Optional[Dict] = None, inv_monom: Optional[List] = None):
    """
    Turn a sympy polynomial into arraylike representation.
    """
    dict_monom, inv_monom = _get_dict_monom_and_inv_monom(poly, dict_monom, inv_monom)
    ...
    return Poly(cycle_expansion(val))
